            ...
            <Overlay isVisible={selectedDoctor !== null} fullScreen>
                <View style={styles.container}>
                    <View style={styles.userMetaContainer}>
                        <Avatar size={40} rounded title={transformName(selectedDoctor.name)} containerStyle={{backgroundColor: '#3d4db7'}}/>
                    ...
                    <View style={styles.mapContainer}>
                        ...
                        initialRegion={{
                            ...
                            icon={require('../assets/doctor (1).png')}
                            />
                        </MapView>
                    </View>
                    }
                    <Button title="عودة" style={{marginTop: '50px'}} onPress={closeModal}></Button>
                </View>
            </Overlay>
        )
    }
